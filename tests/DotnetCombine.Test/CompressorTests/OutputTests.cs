...
namespace DotnetCombine.Test.CompressorTests
{
    public class OutputTests : BaseCompressorTests
    {
        ...
        [InlineData("OutPutfilename" + OutputFileBase.ZipOutputExtension)]
        [InlineData(DefaultOutputDir + "/OutPutfilename")]
        [InlineData(DefaultOutputDir + "/nonexistingFolder/OutPutfilename")]
        [InlineData(DefaultOutputDir + "/nonexistingFolder/OutPutfilename" + OutputFileBase.ZipOutputExtension)]
        public void OutPut(string output)
        {
            ...
            var zipFiles = existingFiles.Where(f => Path.GetFileNameWithoutExtension(f) == "OutPutfilename" && Path.GetExtension(f) == OutputFileBase.ZipOutputExtension);
        ...
        public void NoOutputFileName_GeneratesUniqueFileName(string outputDir)
        {
            ...
            {
                if (Path.GetExtension(f) == OutputFileBase.ZipOutputExtension)
                {
        ...
        [InlineData(nameof(NoOutputDir_UsesInputDirAndOutputFileName), OutputFileBase.ZipOutputExtension)]
        public void NoOutputDir_UsesInputDirAndOutputFileName(string fileName, string extension)
        {
            ...
            var zipFiles = existingFiles.Where(f => Path.GetFileNameWithoutExtension(f) == fileName && Path.GetExtension(f) == OutputFileBase.ZipOutputExtension);
        ...
        [InlineData(DefaultOutputDir + "/OutputPrefix/filename" + OutputFileBase.ZipOutputExtension)]
        public void OutputPrefix(string output)
        {
            ...
            var zipFiles = existingFiles.Where(f =>
                ...
                && Path.GetExtension(f) == OutputFileBase.ZipOutputExtension);
        ...
        [InlineData(DefaultOutputDir + "/OutputSuffix/filename" + OutputFileBase.ZipOutputExtension)]
        ...
        [InlineData(DefaultOutputDir + "/OutputPrefixSuffix/filename" + OutputFileBase.ZipOutputExtension)]
        ...
        public void NoOutputAndInputFile()
        {
            ...
            var zipFiles = existingFiles.Where(f => Path.GetExtension(f) == OutputFileBase.ZipOutputExtension
